        ...
        <div data-thq="thq-navbar-nav" className="navbar2-desktop-menu">
          <nav className="navbar2-links1">
            ...
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar2-text2">Plant Care Guides</span>
                </Fragment>
              )}
            </a>
            <a href={props.link3Url} className="thq-body-small thq-link">
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar2-text4">Landscaping Tips</span>
                </Fragment>
              )}
            </a>
            <a href={props.link4Url} className="thq-body-small thq-link">
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar2-text1">Outdoor Design Ideas</span>
                </Fragment>
              )}
            </a>
          </nav>
          ...
          <div className="navbar2-nav">
            ...
            <nav className="navbar2-links2">
              ...
              <a href={props.link5Url} className="thq-body-small thq-link">
                {props.link5 ?? (
                  <Fragment>
                    <span className="navbar2-text5">Pricing Plans</span>
                  </Fragment>
                )}
              </a>
            </nav>
