          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text19">Get Started</span>
                  </Fragment>
                )}
              </span>
            </button>
        ...
        <div data-thq="thq-mobile-menu" className="navbar8-mobile-menu">
          <div className="navbar8-nav">
            ...
            <nav className="navbar8-links2">
              <a
                href={props.link1Url}
                className="navbar8-link1 thq-body-small thq-link"
              >
                {props.link1 ?? (
                  <Fragment>
              ...
              <a href={props.link2Url} className="thq-body-small thq-link">
                {props.link2 ?? (
                  <Fragment>
                    <span className="navbar8-text21">/plants</span>
                  </Fragment>
                )}
              </a>
              <a
              ...
              >
                {props.link3 ?? (
                  <Fragment>
                    <span className="navbar8-text22">/outdoor-spaces</span>
                  </Fragment>
                )}
              </a>
              <div className="navbar8-link4-accordion">
                ...
                >
                  <span className="thq-body-small thq-link">
                    {props.link4 ?? (
                      <Fragment>
                        <span className="navbar8-text23">/landscaping</span>
                      </Fragment>
                    )}
                  </span>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text17">
                                  Welcome to Heckyourgarden, your ultimate
                                  gardening resource!
                                </span>
                              </Fragment>
                            )}
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text24">Plants</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text25">
                                  Discover a variety of plants and learn how to
                                  care for them.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text18">
                                  Get inspired to create stunning outdoor spaces
                                  with our tips and ideas.
                                </span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text14">
                                  Transform your garden with our landscaping
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text17">
                            Welcome to Heckyourgarden, your ultimate gardening
                            resource!
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text25">
                            Discover a variety of plants and learn how to care
                            for them.
                          </span>
                        </Fragment>
                      )}
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text15">Outdoor Spaces</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text18">
                            Get inspired to create stunning outdoor spaces with
                            our tips and ideas.
                          </span>
                        </Fragment>
                      )}
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text26">Landscaping</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text14">
                            Transform your garden with our landscaping guides
                            and techniques.
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1634428951226-f38c607e2a4d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTMyNTg0MXw&ixlib=rb-4.1.0&q=80&w=1080',
  link1: undefined,
  ...
  page4ImageAlt: 'Image of a landscaped garden',
  action2: undefined,
  ...
  link2: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1738975293838-963ade778b4f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTMyNTg0Mnw&ixlib=rb-4.1.0&q=80&w=1080',
  link3: undefined,
  link4: undefined,
  page1ImageSrc:
